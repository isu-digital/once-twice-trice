...
{% include feature/image-float.html objectid="demo_001" float="start" width="50" %}
...
{% include feature/image-float.html objectid="demo_001" float="end" width="50" %}
...
{% include feature/image.html objectid="demo_006" caption=false %}
